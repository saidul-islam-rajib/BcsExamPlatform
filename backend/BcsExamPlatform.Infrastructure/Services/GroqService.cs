        ...
        string language = "English")
    {
        try
        {
            ...
            var requestBody = new
            {
                ...
                messages = new[]
                {
                    new { role = "system", content = "You are an expert BCS exam question generator. Generate high-quality multiple-choice questions with 4 options each. Return ONLY valid JSON, no markdown." },
